...
from server.schemas import KpiResponse, SkuResponse, ScenarioResponse, SubmitRequest, SubmitResponse, Guardrails, SkuAction
from server.crud import get_all_products_with_metrics, get_scenario_by_name, create_submission
...
def submit_assortment(payload: SubmitRequest, db: Session = Depends(get_db)):
    ...
    actions_list = [{"sku_id": a.sku_id, "action": a.action} for a in payload.sku_actions]
